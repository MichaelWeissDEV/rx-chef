...
```console
rxchef run "LZString Decompress" --input-file input.bin --output-file output.bin
```
...
Correctness tests:
- tests/tests/operations/lz_string_decompress.rs
