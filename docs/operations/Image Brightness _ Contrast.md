...
Source module: `src/operations/image_brightness_contrast.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
