...
Source module: `src/operations/fletcher8_checksum.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
