...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Key | `String` | no | `<empty>` | — | no | Encryption key as UTF-8 or hex (prefix 0x for hex) |
...
Source module: `src/operations/rc2_encrypt.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
