...
Source module: `src/operations/scan_for_embedded_files.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
