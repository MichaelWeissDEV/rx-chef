...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Private key of signer | `String` | no | `<empty>` | — | yes | ASCII-armoured PGP private key of the signer |
...
Source module: `src/operations/pgp_encrypt_and_sign.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
