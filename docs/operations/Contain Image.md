...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Width | `Integer` | no | `100` | — | no | The width of the contained image |
| 2 | Height | `Integer` | no | `100` | — | no | The height of the contained image |
...
Source module: `src/operations/contain_image.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
