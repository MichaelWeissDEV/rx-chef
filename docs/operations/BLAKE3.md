...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Size (bytes) | `Integer` | no | `32` | — | no | Output size in bytes |
| 2 | Key | `String` | no | `<empty>` | — | no | Optional key for keyed hashing |
...
Source module: `src/operations/blake3.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
