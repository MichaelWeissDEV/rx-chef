...
Source module: `src/operations/compare_ssdeep_hashes.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
