...
Source module: `src/operations/a1z26_cipher_encode.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
