...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Private Key | `String` | no | `<empty>` | — | yes | The private key in hex format (32 bytes) |
...
Source module: `src/operations/sm2_decrypt.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
