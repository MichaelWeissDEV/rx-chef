...
Source module: `src/operations/microsoft_script_decoder.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
