...
Source module: `src/operations/group_ip_addresses.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
