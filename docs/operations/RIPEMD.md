...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Size | `Integer` | no | `160` | — | no | Output size in bits (320, 256, 160, or 128) |
...
Source module: `src/operations/ripemd.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
