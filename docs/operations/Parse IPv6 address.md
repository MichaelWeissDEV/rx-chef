...
Source module: `src/operations/parse_ipv6_address.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
