...
```console
printf 'input' | rxchef run "RC6 Encrypt"
```

For file or binary input use `rxchef run "RC6 Encrypt" --input-file INPUT --output-file OUTPUT`.

## Pipeline usage

```console
printf 'input' | rxchef pipe "RC6 Encrypt" to_base64
```
