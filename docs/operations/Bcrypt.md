...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Rounds | `Integer` | no | `10` | — | no | Number of rounds (10-31, default 10) |
...
Source module: `src/operations/bcrypt.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
