...
Source module: `src/operations/index_of_coincidence.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
