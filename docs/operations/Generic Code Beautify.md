...
Source module: `src/operations/generic_code_beautify.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
