...
| 2 | Translation | `String` | no | `0/1` | — | no | Translation method (0/1, A/B, Case, or A-M/N-Z) |
...
Source module: `src/operations/bacon_cipher_decode.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
