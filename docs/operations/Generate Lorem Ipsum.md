...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Length | `Integer` | no | `3` | — | no | Number of units to generate |
...
Source module: `src/operations/generate_lorem_ipsum.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
