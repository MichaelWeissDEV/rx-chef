...
```console
printf 'input' | rxchef run "To Hex"
```

For file or binary input use `rxchef run "To Hex" --input-file INPUT --output-file OUTPUT`.

## Pipeline usage

```console
printf 'input' | rxchef pipe "To Hex" to_base64
```
