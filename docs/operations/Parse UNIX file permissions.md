...
Source module: `src/operations/parse_unix_file_permissions.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
