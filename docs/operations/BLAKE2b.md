...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Size | `Integer` | no | `512` | — | no | Output size in bits (512, 384, 256, 160, 128) |
...
Source module: `src/operations/blake2b.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
