...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Rounds | `Integer` | no | `80` | — | no | Number of rounds (minimum 16) |
...
Source module: `src/operations/sha0.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
