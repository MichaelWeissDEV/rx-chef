...
Source module: `src/operations/generate_ecdsa_key_pair.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
