...
Source module: `src/operations/defang_ip_addresses.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
