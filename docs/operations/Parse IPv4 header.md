...
Source module: `src/operations/parse_ipv4_header.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
