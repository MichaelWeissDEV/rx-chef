...
Source module: `src/operations/xkcd_random_number.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
