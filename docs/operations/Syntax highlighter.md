...
Source module: `src/operations/syntax_highlighter.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
