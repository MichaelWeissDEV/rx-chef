...
|---:|---|---|:---:|---|---|:---:|---|
| 1 | Private/Secret Key | `String` | no | `secret` | — | yes | The secret key for HMAC signing |
...
Source module: `src/operations/jwt_sign.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
