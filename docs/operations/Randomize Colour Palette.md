...
Source module: `src/operations/randomize_colour_palette.rs`. Execution uses `rxchef::execute`; CLI, recipes, and the stdio server do not carry separate operation logic.
