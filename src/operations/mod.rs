...
pub fn operation_names() -> Vec<String> {
    ...
    names.push(
        cetacean_cipher_decode::CetaceanCipherDecode
            .name()
            .to_string(),
    );
    names.push(
        cetacean_cipher_encode::CetaceanCipherEncode
            .name()
            .to_string(),
    );
    ...
    names.push(
        cipher_saber2_decrypt::CipherSaber2Decrypt
            .name()
            .to_string(),
    );
    names.push(
        cipher_saber2_encrypt::CipherSaber2Encrypt
            .name()
            .to_string(),
    );
    ...
    names.push(
        compare_ssdeep_hashes::CompareSSDEEPHashes
            .name()
            .to_string(),
    );
    ...
    names.push(
        convert_coordinate_format::ConvertCoordinateFormat
            .name()
            .to_string(),
    );
    ...
    names.push(
        convert_to_nato_alphabet::ConvertToNATOAlphabet
            .name()
            .to_string(),
    );
    ...
    names.push(
        dechunk_http_response::DechunkHttpResponse
            .name()
            .to_string(),
    );
    ...
    names.push(
        ecdsa_signature_conversion::ECDSASignatureConversion
            .name()
            .to_string(),
    );
    ...
    names.push(
        escape_unicode_characters::EscapeUnicodeCharacters
            .name()
            .to_string(),
    );
    names.push(
        expand_alphabet_range::ExpandAlphabetRange
            .name()
            .to_string(),
    );
    names.push(
        extract_audio_metadata::ExtractAudioMetadata
            .name()
            .to_string(),
    );
    ...
    names.push(
        extract_email_addresses::ExtractEmailAddresses
            .name()
            .to_string(),
    );
    ...
    names.push(
        extract_mac_addresses::ExtractMACAddresses
            .name()
            .to_string(),
    );
    ...
    names.push(
        from_case_insensitive_regex::FromCaseInsensitiveRegex
            .name()
            .to_string(),
    );
    ...
    names.push(
        from_quoted_printable::FromQuotedPrintable
            .name()
            .to_string(),
    );
    ...
    names.push(
        generate_all_checksums::GenerateAllChecksums
            .name()
            .to_string(),
    );
    names.push(generate_all_hashes::GenerateAllHashes.name().to_string());
    names.push(
        generate_de_bruijn_sequence::GenerateDeBruijnSequence
            .name()
            .to_string(),
    );
    names.push(
        generate_ecdsa_key_pair::GenerateECDSAKeyPairOp
            .name()
            .to_string(),
    );
    ...
    names.push(
        generic_code_beautify::GenericCodeBeautify
            .name()
            .to_string(),
    );
    ...
    names.push(
        hassh_client_fingerprint::HASSHClientFingerprint
            .name()
            .to_string(),
    );
    names.push(
        hassh_server_fingerprint::HASSHServerFingerprint
            .name()
            .to_string(),
    );
    ...
    names.push(
        hex_to_object_identifier::HexToObjectIdentifier
            .name()
            .to_string(),
    );
    ...
    names.push(
        image_brightness_contrast::ImageBrightnessContrast
            .name()
            .to_string(),
    );
    names.push(image_filter::ImageFilter.name().to_string());
    names.push(
        image_hue_saturation_lightness::ImageHueSaturationLightness
            .name()
            .to_string(),
    );
    ...
    names.push(
        ipv6_transition_addresses::IPv6TransitionAddresses
            .name()
            .to_string(),
    );
    ...
    names.push(
        ja4_server_fingerprint::JA4ServerFingerprint
            .name()
            .to_string(),
    );
    ...
    names.push(
        microsoft_script_decoder::MicrosoftScriptDecoder
            .name()
            .to_string(),
    );
    ...
    names.push(
        object_identifier_to_hex::ObjectIdentifierToHex
            .name()
            .to_string(),
    );
    ...
    names.push(
        parse_object_id_timestamp::ParseObjectIDTimestamp
            .name()
            .to_string(),
    );
    ...
    names.push(
        parse_unix_file_permissions::ParseUNIXFilePermissions
            .name()
            .to_string(),
    );
    ...
    names.push(
        parse_x509_certificate::ParseX509Certificate
            .name()
            .to_string(),
    );
    ...
    names.push(
        pgp_decrypt_and_verify::PGPDecryptAndVerify
            .name()
            .to_string(),
    );
    ...
    names.push(
        pseudo_random_integer_generator::PseudoRandomIntegerGenerator
            .name()
            .to_string(),
    );
    names.push(
        pseudo_random_number_generator::PseudoRandomNumberGenerator
            .name()
            .to_string(),
    );
    names.push(pub_key_from_cert::PubKeyFromCert.name().to_string());
    names.push(
        pub_key_from_priv_key::PubKeyFromPrivKeyOp
            .name()
            .to_string(),
    );
    names.push(rabbit::RabbitOp.name().to_string());
    names.push(
        rail_fence_cipher_decode::RailFenceCipherDecode
            .name()
            .to_string(),
    );
    names.push(
        rail_fence_cipher_encode::RailFenceCipherEncode
            .name()
            .to_string(),
    );
    names.push(rake::RAKE.name().to_string());
    names.push(
        randomize_colour_palette::RandomizeColourPalette
            .name()
            .to_string(),
    );
    ...
    names.push(
        scan_for_embedded_files::ScanForEmbeddedFiles
            .name()
            .to_string(),
    );
    ...
    names.push(
        split_colour_channels::SplitColourChannels
            .name()
            .to_string(),
    );
    ...
    names.push(
        text_encoding_brute_force::TextEncodingBruteForce
            .name()
            .to_string(),
    );
    names.push(
        text_integer_converter::TextIntegerConverter
            .name()
            .to_string(),
    );
    ...
    names.push(
        to_case_insensitive_regex::ToCaseInsensitiveRegex
            .name()
            .to_string(),
    );
    ...
    names.push(
        translate_date_time_format::TranslateDateTimeFormat
            .name()
            .to_string(),
    );
    ...
    names.push(
        unescape_unicode_characters::UnescapeUnicodeCharacters
            .name()
            .to_string(),
    );
    ...
    names.push(
        unix_timestamp_to_windows_filetime::UNIXTimestampToWindowsFiletime
            .name()
            .to_string(),
    );
    ...
    names.push(
        windows_filetime_to_unix_timestamp::WindowsFiletimeToUnixTimestampOp
            .name()
            .to_string(),
    );
...
pub fn get_operation(name: &str) -> Option<Box<dyn Operation>> {
    let lowered = name.to_lowercase();
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(a1z26_cipher_decode::A1Z26CipherDecode));
        }
    }
    {
        let op = a1z26_cipher_encode::A1Z26CipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(a1z26_cipher_encode::A1Z26CipherEncode));
        }
    }
    {
        let op = add::AddOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(add::AddOp));
        }
    }
    {
        let op = add_line_numbers::AddLineNumbers;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(add_line_numbers::AddLineNumbers));
        }
    }
    {
        let op = add_text_to_image::AddTextToImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(add_text_to_image::AddTextToImage));
        }
    }
    {
        let op = adler32_checksum::Adler32Checksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(adler32_checksum::Adler32Checksum));
        }
    }
    {
        let op = aes_decrypt::AesDecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(aes_decrypt::AesDecrypt));
        }
    }
    {
        let op = aes_encrypt::AesEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(aes_encrypt::AesEncrypt));
        }
    }
    {
        let op = aes_key_unwrap::AesKeyUnwrap;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(aes_key_unwrap::AesKeyUnwrap));
        }
    }
    {
        let op = aes_key_wrap::AesKeyWrap;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(aes_key_wrap::AesKeyWrap));
        }
    }
    {
        let op = affine_cipher_decode::AffineCipherDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(affine_cipher_decode::AffineCipherDecode));
        }
    }
    {
        let op = affine_cipher_encode::AffineCipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(affine_cipher_encode::AffineCipherEncode));
        }
    }
    {
        let op = alternating_caps::AlternatingCaps;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(alternating_caps::AlternatingCaps));
        }
    }
    {
        let op = amf_decode::AmfDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(amf_decode::AmfDecode));
        }
    }
    {
        let op = amf_encode::AmfEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(amf_encode::AmfEncode));
        }
    }
    {
        let op = analyse_hash::AnalyseHash;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(analyse_hash::AnalyseHash));
        }
    }
    {
        let op = analyse_uuid::AnalyseUUID;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(analyse_uuid::AnalyseUUID));
        }
    }
    {
        let op = and::AndOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(and::AndOp));
        }
    }
    {
        let op = argon2::Argon2;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(argon2::Argon2));
        }
    }
    {
        let op = argon2_compare::Argon2Compare;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(argon2_compare::Argon2Compare));
        }
    }
    {
        let op = atbash_cipher::AtbashCipher;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(atbash_cipher::AtbashCipher));
        }
    }
    {
        let op = avro_to_json::AvroToJSON;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(avro_to_json::AvroToJSON));
        }
    }
    {
        let op = bacon_cipher_decode::BaconCipherDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bacon_cipher_decode::BaconCipherDecode));
        }
    }
    {
        let op = bacon_cipher_encode::BaconCipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bacon_cipher_encode::BaconCipherEncode));
        }
    }
    {
        let op = bcrypt::Bcrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bcrypt::Bcrypt));
        }
    }
    {
        let op = bcrypt_compare::BcryptCompare;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bcrypt_compare::BcryptCompare));
        }
    }
    {
        let op = bcrypt_parse::BcryptParse;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bcrypt_parse::BcryptParse));
        }
    }
    {
        let op = bifid_cipher_decode::BifidCipherDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bifid_cipher_decode::BifidCipherDecode));
        }
    }
    {
        let op = bifid_cipher_encode::BifidCipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bifid_cipher_encode::BifidCipherEncode));
        }
    }
    {
        let op = bit_shift_left::BitShiftLeft;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bit_shift_left::BitShiftLeft));
        }
    }
    {
        let op = bit_shift_right::BitShiftRight;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bit_shift_right::BitShiftRight));
        }
    }
    {
        let op = blake2b::BLAKE2b;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blake2b::BLAKE2b));
        }
    }
    {
        let op = blake2s::BLAKE2s;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blake2s::BLAKE2s));
        }
    }
    {
        let op = blake3::BLAKE3;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blake3::BLAKE3));
        }
    }
    {
        let op = blowfish_decrypt::BlowfishDecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blowfish_decrypt::BlowfishDecrypt));
        }
    }
    {
        let op = blowfish_encrypt::BlowfishEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blowfish_encrypt::BlowfishEncrypt));
        }
    }
    {
        let op = blur_image::BlurImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(blur_image::BlurImage));
        }
    }
    {
        let op = bombe::Bombe;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bombe::Bombe));
        }
    }
    {
        let op = bson_deserialise::BsonDeserialise;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bson_deserialise::BsonDeserialise));
        }
    }
    {
        let op = bson_serialise::BsonSerialise;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bson_serialise::BsonSerialise));
        }
    }
    {
        let op = bzip2_compress::Bzip2Compress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bzip2_compress::Bzip2Compress));
        }
    }
    {
        let op = bzip2_decompress::Bzip2Decompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(bzip2_decompress::Bzip2Decompress));
        }
    }
    {
        let op = caesar_box_cipher::CaesarBoxCipher;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(caesar_box_cipher::CaesarBoxCipher));
        }
    }
    {
        let op = caret_mdecode::CaretMdecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(caret_mdecode::CaretMdecode));
        }
    }
    {
        let op = cartesian_product::CartesianProduct;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cartesian_product::CartesianProduct));
        }
    }
    {
        let op = cbor_decode::CBORDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cbor_decode::CBORDecode));
        }
    }
    {
        let op = cbor_encode::CBOREncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cbor_encode::CBOREncode));
        }
    }
    {
        let op = cetacean_cipher_decode::CetaceanCipherDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cetacean_cipher_decode::CetaceanCipherDecode));
        }
    }
    {
        let op = cetacean_cipher_encode::CetaceanCipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cetacean_cipher_encode::CetaceanCipherEncode));
        }
    }
    {
        let op = chacha::ChaCha;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(chacha::ChaCha));
        }
    }
    {
        let op = change_ip_format::ChangeIPFormat;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(change_ip_format::ChangeIPFormat));
        }
    }
    {
        let op = chi_square::ChiSquare;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(chi_square::ChiSquare));
        }
    }
    {
        let op = cipher_saber2_decrypt::CipherSaber2Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cipher_saber2_decrypt::CipherSaber2Decrypt));
        }
    }
    {
        let op = cipher_saber2_encrypt::CipherSaber2Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cipher_saber2_encrypt::CipherSaber2Encrypt));
        }
    }
    {
        let op = citrix_ctx1_decode::CitrixCtx1Decode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(citrix_ctx1_decode::CitrixCtx1Decode));
        }
    }
    {
        let op = citrix_ctx1_encode::CitrixCtx1Encode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(citrix_ctx1_encode::CitrixCtx1Encode));
        }
    }
    {
        let op = cmac::Cmac;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cmac::Cmac));
        }
    }
    {
        let op = colossus::Colossus;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(colossus::Colossus));
        }
    }
    {
        let op = comment::CommentOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(comment::CommentOp));
        }
    }
    {
        let op = compare_ctph_hashes::CompareCTPHHashes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(compare_ctph_hashes::CompareCTPHHashes));
        }
    }
    {
        let op = compare_ssdeep_hashes::CompareSSDEEPHashes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(compare_ssdeep_hashes::CompareSSDEEPHashes));
        }
    }
    {
        let op = conditional_jump::ConditionalJump;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(conditional_jump::ConditionalJump));
        }
    }
    {
        let op = contain_image::ContainImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(contain_image::ContainImage));
        }
    }
    {
        let op = convert_area::ConvertArea;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_area::ConvertArea));
        }
    }
    {
        let op = convert_coordinate_format::ConvertCoordinateFormat;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_coordinate_format::ConvertCoordinateFormat));
        }
    }
    {
        let op = convert_data_units::ConvertDataUnits;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_data_units::ConvertDataUnits));
        }
    }
    {
        let op = convert_distance::ConvertDistance;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_distance::ConvertDistance));
        }
    }
    {
        let op = convert_image_format::ConvertImageFormat;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_image_format::ConvertImageFormat));
        }
    }
    {
        let op = convert_leet_speak::ConvertLeetSpeak;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_leet_speak::ConvertLeetSpeak));
        }
    }
    {
        let op = convert_mass::ConvertMass;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_mass::ConvertMass));
        }
    }
    {
        let op = convert_speed::ConvertSpeed;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_speed::ConvertSpeed));
        }
    }
    {
        let op = convert_to_nato_alphabet::ConvertToNATOAlphabet;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(convert_to_nato_alphabet::ConvertToNATOAlphabet));
        }
    }
    {
        let op = count_occurrences::CountOccurrences;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(count_occurrences::CountOccurrences));
        }
    }
    {
        let op = cover_image::CoverImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(cover_image::CoverImage));
        }
    }
    {
        let op = crc32::CRC32;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(crc32::CRC32));
        }
    }
    {
        let op = crc_checksum::CrcChecksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(crc_checksum::CrcChecksum));
        }
    }
    {
        let op = crop_image::CropImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(crop_image::CropImage));
        }
    }
    {
        let op = css_beautify::CssBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(css_beautify::CssBeautify));
        }
    }
    {
        let op = css_minify::CssMinify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(css_minify::CssMinify));
        }
    }
    {
        let op = css_selector::CssSelector;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(css_selector::CssSelector));
        }
    }
    {
        let op = csv_to_json::CsvToJson;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(csv_to_json::CsvToJson));
        }
    }
    {
        let op = ctph::CTPH;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ctph::CTPH));
        }
    }
    {
        let op = date_time_delta::DateTimeDelta;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(date_time_delta::DateTimeDelta));
        }
    }
    {
        let op = dechunk_http_response::DechunkHttpResponse;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(dechunk_http_response::DechunkHttpResponse));
        }
    }
    {
        let op = decode_netbios_name::DecodeNetBIOSName;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(decode_netbios_name::DecodeNetBIOSName));
        }
    }
    {
        let op = decode_text::DecodeText;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(decode_text::DecodeText));
        }
    }
    {
        let op = defang_ip_addresses::DefangIPAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(defang_ip_addresses::DefangIPAddresses));
        }
    }
    {
        let op = defang_url::DefangURL;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(defang_url::DefangURL));
        }
    }
    {
        let op = derive_evp_key::DeriveEvpKey;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(derive_evp_key::DeriveEvpKey));
        }
    }
    {
        let op = derive_hkdf_key::DeriveHKDFKey;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(derive_hkdf_key::DeriveHKDFKey));
        }
    }
    {
        let op = derive_pbkdf2_key::DerivePBKDF2Key;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(derive_pbkdf2_key::DerivePBKDF2Key));
        }
    }
    {
        let op = des_decrypt::DesDecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(des_decrypt::DesDecrypt));
        }
    }
    {
        let op = des_encrypt::DesEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(des_encrypt::DesEncrypt));
        }
    }
    {
        let op = detect_file_type::DetectFileType;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(detect_file_type::DetectFileType));
        }
    }
    {
        let op = diff::Diff;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(diff::Diff));
        }
    }
    {
        let op = disassemble_arm::DisassembleArm;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(disassemble_arm::DisassembleArm));
        }
    }
    {
        let op = disassemble_x86::DisassembleX86;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(disassemble_x86::DisassembleX86));
        }
    }
    {
        let op = dither_image::DitherImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(dither_image::DitherImage));
        }
    }
    {
        let op = divide::Divide;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(divide::Divide));
        }
    }
    {
        let op = dns_over_https::DnsOverHttps;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(dns_over_https::DnsOverHttps));
        }
    }
    {
        let op = drop_bytes::DropBytes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(drop_bytes::DropBytes));
        }
    }
    {
        let op = drop_nth_bytes::DropNthBytes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(drop_nth_bytes::DropNthBytes));
        }
    }
    {
        let op = ecdsa_sign::ECDSASign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ecdsa_sign::ECDSASign));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ecdsa_verify::ECDSAVerify));
        }
    }
    {
        let op = elf_info::ELFInfo;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(elf_info::ELFInfo));
        }
    }
    {
        let op = encode_netbios_name::EncodeNetBIOSName;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(encode_netbios_name::EncodeNetBIOSName));
        }
    }
    {
        let op = encode_text::EncodeText;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(encode_text::EncodeText));
        }
    }
    {
        let op = enigma::Enigma;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(enigma::Enigma));
        }
    }
    {
        let op = entropy::Entropy;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(entropy::Entropy));
        }
    }
    {
        let op = escape_string::EscapeString;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(escape_string::EscapeString));
        }
    }
    {
        let op = escape_unicode_characters::EscapeUnicodeCharacters;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(escape_unicode_characters::EscapeUnicodeCharacters));
        }
    }
    {
        let op = expand_alphabet_range::ExpandAlphabetRange;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(expand_alphabet_range::ExpandAlphabetRange));
        }
    }
    {
        let op = extract_audio_metadata::ExtractAudioMetadata;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_audio_metadata::ExtractAudioMetadata));
        }
    }
    {
        let op = extract_dates::ExtractDates;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_dates::ExtractDates));
        }
    }
    {
        let op = extract_domains::ExtractDomains;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_domains::ExtractDomains));
        }
    }
    {
        let op = extract_email_addresses::ExtractEmailAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_email_addresses::ExtractEmailAddresses));
        }
    }
    {
        let op = extract_exif::ExtractEXIF;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_exif::ExtractEXIF));
        }
    }
    {
        let op = extract_file_paths::ExtractFilePaths;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_file_paths::ExtractFilePaths));
        }
    }
    {
        let op = extract_files::ExtractFiles;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_files::ExtractFiles));
        }
    }
    {
        let op = extract_hashes::ExtractHashes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_hashes::ExtractHashes));
        }
    }
    {
        let op = extract_id3::ExtractID3;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_id3::ExtractID3));
        }
    }
    {
        let op = extract_ip_addresses::ExtractIPAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_ip_addresses::ExtractIPAddresses));
        }
    }
    {
        let op = extract_lsb::ExtractLSB;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_lsb::ExtractLSB));
        }
    }
    {
        let op = extract_mac_addresses::ExtractMACAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_mac_addresses::ExtractMACAddresses));
        }
    }
    {
        let op = extract_rgba::ExtractRGBA;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_rgba::ExtractRGBA));
        }
    }
    {
        let op = extract_urls::ExtractURLs;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(extract_urls::ExtractURLs));
        }
    }
    {
        let op = fang_url::FangURL;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fang_url::FangURL));
        }
    }
    {
        let op = fernet_decrypt::FernetDecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fernet_decrypt::FernetDecrypt));
        }
    }
    {
        let op = fernet_encrypt::FernetEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fernet_encrypt::FernetEncrypt));
        }
    }
    {
        let op = file_tree::FileTree;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(file_tree::FileTree));
        }
    }
    {
        let op = filter::Filter;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(filter::Filter));
        }
    }
    {
        let op = find_replace::FindReplace;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(find_replace::FindReplace));
        }
    }
    {
        let op = flask_session_decode::FlaskSessionDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(flask_session_decode::FlaskSessionDecode));
        }
    }
    {
        let op = flask_session_sign::FlaskSessionSign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(flask_session_sign::FlaskSessionSign));
        }
    }
    {
        let op = flask_session_verify::FlaskSessionVerify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(flask_session_verify::FlaskSessionVerify));
        }
    }
    {
        let op = fletcher16_checksum::Fletcher16Checksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fletcher16_checksum::Fletcher16Checksum));
        }
    }
    {
        let op = fletcher32_checksum::Fletcher32Checksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fletcher32_checksum::Fletcher32Checksum));
        }
    }
    {
        let op = fletcher64_checksum::Fletcher64Checksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fletcher64_checksum::Fletcher64Checksum));
        }
    }
    {
        let op = fletcher8_checksum::Fletcher8Checksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fletcher8_checksum::Fletcher8Checksum));
        }
    }
    {
        let op = flip_image::FlipImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(flip_image::FlipImage));
        }
    }
    {
        let op = fork::Fork;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fork::Fork));
        }
    }
    {
        let op = format_mac_addresses::FormatMACAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(format_mac_addresses::FormatMACAddresses));
        }
    }
    {
        let op = frequency_distribution::FrequencyDistribution;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(frequency_distribution::FrequencyDistribution));
        }
    }
    {
        let op = from_base::FromBase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base::FromBase));
        }
    }
    {
        let op = from_base32::FromBase32;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base32::FromBase32));
        }
    }
    {
        let op = from_base45::FromBase45;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base45::FromBase45));
        }
    }
    {
        let op = from_base58::FromBase58;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base58::FromBase58));
        }
    }
    {
        let op = from_base62::FromBase62;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base62::FromBase62));
        }
    }
    {
        let op = from_base64::FromBase64;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base64::FromBase64));
        }
    }
    {
        let op = from_base85::FromBase85;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base85::FromBase85));
        }
    }
    {
        let op = from_base92::FromBase92;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_base92::FromBase92));
        }
    }
    {
        let op = from_bcd::FromBCD;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_bcd::FromBCD));
        }
    }
    {
        let op = from_bech32::FromBech32;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_bech32::FromBech32));
        }
    }
    {
        let op = from_binary::FromBinary;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_binary::FromBinary));
        }
    }
    {
        let op = from_braille::FromBraille;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_braille::FromBraille));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_charcode::FromCharcode));
        }
    }
    {
        let op = from_decimal::FromDecimal;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_decimal::FromDecimal));
        }
    }
    {
        let op = from_float::FromFloat;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_float::FromFloat));
        }
    }
    {
        let op = from_hex::FromHex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_hex::FromHex));
        }
    }
    {
        let op = from_hex_content::FromHexContent;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_hex_content::FromHexContent));
        }
    }
    {
        let op = from_hexdump::FromHexdump;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_hexdump::FromHexdump));
        }
    }
    {
        let op = from_html_entity::FromHTMLEntity;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_html_entity::FromHTMLEntity));
        }
    }
    {
        let op = from_message_pack::FromMessagePack;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_message_pack::FromMessagePack));
        }
    }
    {
        let op = from_modhex::FromModhex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_modhex::FromModhex));
        }
    }
    {
        let op = from_morse_code::FromMorseCode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_morse_code::FromMorseCode));
        }
    }
    {
        let op = from_octal::FromOctal;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_octal::FromOctal));
        }
    }
    {
        let op = from_punycode::FromPunycode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_punycode::FromPunycode));
        }
    }
    {
        let op = from_quoted_printable::FromQuotedPrintable;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_quoted_printable::FromQuotedPrintable));
        }
    }
    {
        let op = from_unix_timestamp::FromUNIXTimestamp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(from_unix_timestamp::FromUNIXTimestamp));
        }
    }
    {
        let op = fuzzy_match::FuzzyMatch;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(fuzzy_match::FuzzyMatch));
        }
    }
    {
        let op = generate_all_checksums::GenerateAllChecksums;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_all_checksums::GenerateAllChecksums));
        }
    }
    {
        let op = generate_all_hashes::GenerateAllHashes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_all_hashes::GenerateAllHashes));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_ecdsa_key_pair::GenerateECDSAKeyPairOp));
        }
    }
    {
        let op = generate_hotp::GenerateHOTPOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_hotp::GenerateHOTPOp));
        }
    }
    {
        let op = generate_image::GenerateImageOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_image::GenerateImageOp));
        }
    }
    {
        let op = generate_lorem_ipsum::GenerateLoremIpsum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_lorem_ipsum::GenerateLoremIpsum));
        }
    }
    {
        let op = generate_pgp_key_pair::GeneratePGPKeyPair;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_pgp_key_pair::GeneratePGPKeyPair));
        }
    }
    {
        let op = generate_qr_code::GenerateQRCodeOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_qr_code::GenerateQRCodeOp));
        }
    }
    {
        let op = generate_rsa_key_pair::GenerateRSAKeyPair;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_rsa_key_pair::GenerateRSAKeyPair));
        }
    }
    {
        let op = generate_totp::GenerateTOTP;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_totp::GenerateTOTP));
        }
    }
    {
        let op = generate_uuid::GenerateUUID;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generate_uuid::GenerateUUID));
        }
    }
    {
        let op = generic_code_beautify::GenericCodeBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(generic_code_beautify::GenericCodeBeautify));
        }
    }
    {
        let op = get_all_casings::GetAllCasings;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(get_all_casings::GetAllCasings));
        }
    }
    {
        let op = get_time::GetTime;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(get_time::GetTime));
        }
    }
    {
        let op = gost_decrypt::GOSTDecryptOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_decrypt::GOSTDecryptOp));
        }
    }
    {
        let op = gost_encrypt::GostEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_encrypt::GostEncrypt));
        }
    }
    {
        let op = gost_hash::GostHash;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_hash::GostHash));
        }
    }
    {
        let op = gost_key_unwrap::GOSTKeyUnwrapOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_key_unwrap::GOSTKeyUnwrapOp));
        }
    }
    {
        let op = gost_key_wrap::GostKeyWrap;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_key_wrap::GostKeyWrap));
        }
    }
    {
        let op = gost_sign::GostSign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_sign::GostSign));
        }
    }
    {
        let op = gost_verify::GOSTVerifyOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gost_verify::GOSTVerifyOp));
        }
    }
    {
        let op = group_ip_addresses::GroupIPAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(group_ip_addresses::GroupIPAddresses));
        }
    }
    {
        let op = gunzip::Gunzip;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gunzip::Gunzip));
        }
    }
    {
        let op = gzip::Gzip;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(gzip::Gzip));
        }
    }
    {
        let op = hamming_distance::HammingDistance;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hamming_distance::HammingDistance));
        }
    }
    {
        let op = has160::HAS160Op;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(has160::HAS160Op));
        }
    }
    {
        let op = hassh_client_fingerprint::HASSHClientFingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hassh_client_fingerprint::HASSHClientFingerprint));
        }
    }
    {
        let op = hassh_server_fingerprint::HASSHServerFingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hassh_server_fingerprint::HASSHServerFingerprint));
        }
    }
    {
        let op = haversine_distance::HaversineDistance;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(haversine_distance::HaversineDistance));
        }
    }
    {
        let op = head::Head;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(head::Head));
        }
    }
    {
        let op = heatmap_chart::HeatmapChart;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(heatmap_chart::HeatmapChart));
        }
    }
    {
        let op = hex_density_chart::HexDensityChartOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hex_density_chart::HexDensityChartOp));
        }
    }
    {
        let op = hex_to_object_identifier::HexToObjectIdentifier;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hex_to_object_identifier::HexToObjectIdentifier));
        }
    }
    {
        let op = hex_to_pem::HexToPEM;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hex_to_pem::HexToPEM));
        }
    }
    {
        let op = hmac::HMAC;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(hmac::HMAC));
        }
    }
    {
        let op = html_to_text::HTMLToText;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(html_to_text::HTMLToText));
        }
    }
    {
        let op = http_request::HTTPRequest;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(http_request::HTTPRequest));
        }
    }
    {
        let op = image_brightness_contrast::ImageBrightnessContrast;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(image_brightness_contrast::ImageBrightnessContrast));
        }
    }
    {
        let op = image_filter::ImageFilter;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(image_filter::ImageFilter));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(image_opacity::ImageOpacity));
        }
    }
    {
        let op = index_of_coincidence::IndexOfCoincidence;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(index_of_coincidence::IndexOfCoincidence));
        }
    }
    {
        let op = invert_image::InvertImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(invert_image::InvertImage));
        }
    }
    {
        let op = ipv6_transition_addresses::IPv6TransitionAddresses;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ipv6_transition_addresses::IPv6TransitionAddresses));
        }
    }
    {
        let op = j_path_expression::JPathExpression;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(j_path_expression::JPathExpression));
        }
    }
    {
        let op = ja3_fingerprint::JA3Fingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ja3_fingerprint::JA3Fingerprint));
        }
    }
    {
        let op = ja3s_fingerprint::JA3SFingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ja3s_fingerprint::JA3SFingerprint));
        }
    }
    {
        let op = ja4_fingerprint::JA4Fingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ja4_fingerprint::JA4Fingerprint));
        }
    }
    {
        let op = ja4_server_fingerprint::JA4ServerFingerprint;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ja4_server_fingerprint::JA4ServerFingerprint));
        }
    }
    {
        let op = java_script_beautify::JavaScriptBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(java_script_beautify::JavaScriptBeautify));
        }
    }
    {
        let op = java_script_minify::JavaScriptMinify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(java_script_minify::JavaScriptMinify));
        }
    }
    {
        let op = java_script_parser::JavaScriptParser;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(java_script_parser::JavaScriptParser));
        }
    }
    {
        let op = jq::Jq;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jq::Jq));
        }
    }
    {
        let op = json_beautify::JSONBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(json_beautify::JSONBeautify));
        }
    }
    {
        let op = json_minify::JSONMinify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(json_minify::JSONMinify));
        }
    }
    {
        let op = json_to_csv::JSONToCSV;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(json_to_csv::JSONToCSV));
        }
    }
    {
        let op = json_to_yaml::JSONToYAML;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(json_to_yaml::JSONToYAML));
        }
    }
    {
        let op = jsonata::Jsonata;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jsonata::Jsonata));
        }
    }
    {
        let op = jump::Jump;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jump::Jump));
        }
    }
    {
        let op = jwk_to_pem::JWKToPem;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jwk_to_pem::JWKToPem));
        }
    }
    {
        let op = jwt_decode::JWTDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jwt_decode::JWTDecode));
        }
    }
    {
        let op = jwt_sign::JWTSign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jwt_sign::JWTSign));
        }
    }
    {
        let op = jwt_verify::JWTVerify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(jwt_verify::JWTVerify));
        }
    }
    {
        let op = keccak::Keccak;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(keccak::Keccak));
        }
    }
    {
        let op = label::Label;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(label::Label));
        }
    }
    {
        let op = levenshtein_distance::LevenshteinDistance;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(levenshtein_distance::LevenshteinDistance));
        }
    }
    {
        let op = lm_hash::LMHash;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lm_hash::LMHash));
        }
    }
    {
        let op = lorenz::Lorenz;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lorenz::Lorenz));
        }
    }
    {
        let op = ls47_decrypt::LS47Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ls47_decrypt::LS47Decrypt));
        }
    }
    {
        let op = ls47_encrypt::LS47Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ls47_encrypt::LS47Encrypt));
        }
    }
    {
        let op = luhn_checksum::LuhnChecksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(luhn_checksum::LuhnChecksum));
        }
    }
    {
        let op = lz4_compress::LZ4Compress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lz4_compress::LZ4Compress));
        }
    }
    {
        let op = lz4_decompress::LZ4Decompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lz4_decompress::LZ4Decompress));
        }
    }
    {
        let op = lz_string_compress::LZStringCompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lz_string_compress::LZStringCompress));
        }
    }
    {
        let op = lz_string_decompress::LZStringDecompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lz_string_decompress::LZStringDecompress));
        }
    }
    {
        let op = lzma_compress::LZMACompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lzma_compress::LZMACompress));
        }
    }
    {
        let op = lzma_decompress::LZMADecompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lzma_decompress::LZMADecompress));
        }
    }
    {
        let op = lznt1_decompress::LZNT1Decompress;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(lznt1_decompress::LZNT1Decompress));
        }
    }
    {
        let op = magic::Magic;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(magic::Magic));
        }
    }
    {
        let op = md2::MD2;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(md2::MD2));
        }
    }
    {
        let op = md4::MD4;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(md4::MD4));
        }
    }
    {
        let op = md5::MD5;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(md5::MD5));
        }
    }
    {
        let op = md6::MD6;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(md6::MD6));
        }
    }
    {
        let op = mean::Mean;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(mean::Mean));
        }
    }
    {
        let op = median::Median;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(median::Median));
        }
    }
    {
        let op = merge::Merge;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(merge::Merge));
        }
    }
    {
        let op = microsoft_script_decoder::MicrosoftScriptDecoder;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(microsoft_script_decoder::MicrosoftScriptDecoder));
        }
    }
    {
        let op = mime_decoding::MIMEDecoding;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(mime_decoding::MIMEDecoding));
        }
    }
    {
        let op = multiple_bombe::MultipleBombe;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(multiple_bombe::MultipleBombe));
        }
    }
    {
        let op = multiply::Multiply;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(multiply::Multiply));
        }
    }
    {
        let op = murmur_hash3::MurmurHash3;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(murmur_hash3::MurmurHash3));
        }
    }
    {
        let op = normalise_image::NormaliseImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(normalise_image::NormaliseImage));
        }
    }
    {
        let op = normalise_unicode::NormaliseUnicode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(normalise_unicode::NormaliseUnicode));
        }
    }
    {
        let op = not::NOT;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(not::NOT));
        }
    }
    {
        let op = nt_hash::NTHash;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(nt_hash::NTHash));
        }
    }
    {
        let op = numberwang::Numberwang;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(numberwang::Numberwang));
        }
    }
    {
        let op = object_identifier_to_hex::ObjectIdentifierToHex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(object_identifier_to_hex::ObjectIdentifierToHex));
        }
    }
    {
        let op = offset_checker::OffsetChecker;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(offset_checker::OffsetChecker));
        }
    }
    {
    ...
    }
    {
        let op = or::OrOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(or::OrOp));
        }
    }
    {
        let op = pad_lines::PadLines;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pad_lines::PadLines));
        }
    }
    {
        let op = parity_bit::ParityBit;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parity_bit::ParityBit));
        }
    }
    {
        let op = parse_asn1_hex_string::ParseASN1HexString;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_asn1_hex_string::ParseASN1HexString));
        }
    }
    {
        let op = parse_colour_code::ParseColourCode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_colour_code::ParseColourCode));
        }
    }
    {
        let op = parse_csr::ParseCSR;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_csr::ParseCSR));
        }
    }
    {
        let op = parse_date_time::ParseDateTime;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_date_time::ParseDateTime));
        }
    }
    {
        let op = parse_ethernet_frame::ParseEthernetFrame;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_ethernet_frame::ParseEthernetFrame));
        }
    }
    {
        let op = parse_ip_range::ParseIPRange;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_ip_range::ParseIPRange));
        }
    }
    {
        let op = parse_ipv4_header::ParseIPv4Header;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_ipv4_header::ParseIPv4Header));
        }
    }
    {
        let op = parse_ipv6_address::ParseIPv6Address;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_ipv6_address::ParseIPv6Address));
        }
    }
    {
        let op = parse_object_id_timestamp::ParseObjectIDTimestamp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_object_id_timestamp::ParseObjectIDTimestamp));
        }
    }
    {
        let op = parse_qr_code::ParseQRCode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_qr_code::ParseQRCode));
        }
    }
    {
        let op = parse_ssh_host_key::ParseSshHostKey;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_ssh_host_key::ParseSshHostKey));
        }
    }
    {
        let op = parse_tcp::ParseTcp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_tcp::ParseTcp));
        }
    }
    {
        let op = parse_tls_record::ParseTLSRecord;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_tls_record::ParseTLSRecord));
        }
    }
    {
        let op = parse_tlv::ParseTLV;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_tlv::ParseTLV));
        }
    }
    {
        let op = parse_udp::ParseUDP;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_udp::ParseUDP));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_uri::ParseURI));
        }
    }
    {
        let op = parse_user_agent::ParseUserAgent;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_user_agent::ParseUserAgent));
        }
    }
    {
        let op = parse_x509_certificate::ParseX509Certificate;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_x509_certificate::ParseX509Certificate));
        }
    }
    {
        let op = parse_x509_crl::ParseX509CRL;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(parse_x509_crl::ParseX509CRL));
        }
    }
    {
        let op = pem_to_hex::PEMToHex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pem_to_hex::PEMToHex));
        }
    }
    {
        let op = pem_to_jwk::PEMToJWK;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pem_to_jwk::PEMToJWK));
        }
    }
    {
        let op = pgp_decrypt::PGPDecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pgp_decrypt::PGPDecrypt));
        }
    }
    {
        let op = pgp_decrypt_and_verify::PGPDecryptAndVerify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pgp_decrypt_and_verify::PGPDecryptAndVerify));
        }
    }
    {
        let op = pgp_encrypt::PGPEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pgp_encrypt::PGPEncrypt));
        }
    }
    {
        let op = pgp_encrypt_and_sign::PGPEncryptAndSign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pgp_encrypt_and_sign::PGPEncryptAndSign));
        }
    }
    {
        let op = pgp_verify::PGPVerify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pgp_verify::PGPVerify));
        }
    }
    {
        let op = php_deserialize::PHPDeserialize;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(php_deserialize::PHPDeserialize));
        }
    }
    {
        let op = php_serialize::PHPSerialize;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(php_serialize::PHPSerialize));
        }
    }
    {
        let op = play_media::PlayMedia;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(play_media::PlayMedia));
        }
    }
    {
        let op = plist_viewer::PLISTViewer;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(plist_viewer::PLISTViewer));
        }
    }
    {
        let op = power_set::PowerSet;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(power_set::PowerSet));
        }
    }
    {
        let op = protobuf_decode::ProtobufDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(protobuf_decode::ProtobufDecode));
        }
    }
    {
        let op = protobuf_encode::ProtobufEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(protobuf_encode::ProtobufEncode));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pub_key_from_cert::PubKeyFromCert));
        }
    }
    {
        let op = pub_key_from_priv_key::PubKeyFromPrivKeyOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(pub_key_from_priv_key::PubKeyFromPrivKeyOp));
        }
    }
    {
        let op = rabbit::RabbitOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rabbit::RabbitOp));
        }
    }
    {
        let op = rail_fence_cipher_decode::RailFenceCipherDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rail_fence_cipher_decode::RailFenceCipherDecode));
        }
    }
    {
        let op = rail_fence_cipher_encode::RailFenceCipherEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rail_fence_cipher_encode::RailFenceCipherEncode));
        }
    }
    {
        let op = rake::RAKE;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rake::RAKE));
        }
    }
    {
        let op = randomize_colour_palette::RandomizeColourPalette;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(randomize_colour_palette::RandomizeColourPalette));
        }
    }
    {
        let op = raw_deflate::RawDeflate;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(raw_deflate::RawDeflate));
        }
    }
    {
        let op = raw_inflate::RawInflate;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(raw_inflate::RawInflate));
        }
    }
    {
        let op = rc2_decrypt::RC2Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc2_decrypt::RC2Decrypt));
        }
    }
    {
        let op = rc2_encrypt::RC2Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc2_encrypt::RC2Encrypt));
        }
    }
    {
        let op = rc4::RC4;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc4::RC4));
        }
    }
    {
        let op = rc4_drop::RC4Drop;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc4_drop::RC4Drop));
        }
    }
    {
        let op = rc6_decrypt::RC6Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc6_decrypt::RC6Decrypt));
        }
    }
    {
        let op = rc6_encrypt::RC6Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rc6_encrypt::RC6Encrypt));
        }
    }
    {
        let op = register::Register;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(register::Register));
        }
    }
    {
        let op = regular_expression::RegularExpressionOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(regular_expression::RegularExpressionOp));
        }
    }
    {
        let op = remove_diacritics::RemoveDiacritics;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(remove_diacritics::RemoveDiacritics));
        }
    }
    {
        let op = remove_exif::RemoveEXIF;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(remove_exif::RemoveEXIF));
        }
    }
    {
        let op = remove_line_numbers::RemoveLineNumbers;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(remove_line_numbers::RemoveLineNumbers));
        }
    }
    {
        let op = remove_null_bytes::RemoveNullBytes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(remove_null_bytes::RemoveNullBytes));
        }
    }
    {
        let op = remove_whitespace::RemoveWhitespace;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(remove_whitespace::RemoveWhitespace));
        }
    }
    {
        let op = render_image::RenderImageOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(render_image::RenderImageOp));
        }
    }
    {
        let op = render_markdown::RenderMarkdown;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(render_markdown::RenderMarkdown));
        }
    }
    {
        let op = resize_image::ResizeImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(resize_image::ResizeImage));
        }
    }
    {
        let op = return_op::ReturnOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(return_op::ReturnOp));
        }
    }
    {
        let op = reverse::Reverse;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(reverse::Reverse));
        }
    }
    {
        let op = ripemd::RIPEMD;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ripemd::RIPEMD));
        }
    }
    {
        let op = rison_decode::RisonDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rison_decode::RisonDecode));
        }
    }
    {
        let op = rison_encode::RisonEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rison_encode::RisonEncode));
        }
    }
    {
        let op = rot13::ROT13;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rot13::ROT13));
        }
    }
    {
        let op = rot13_brute_force::ROT13BruteForce;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rot13_brute_force::ROT13BruteForce));
        }
    }
    {
        let op = rot47::ROT47;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rot47::ROT47));
        }
    }
    {
        let op = rot47_brute_force::ROT47BruteForce;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rot47_brute_force::ROT47BruteForce));
        }
    }
    {
        let op = rot8000::ROT8000;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rot8000::ROT8000));
        }
    }
    {
        let op = rotate_image::RotateImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rotate_image::RotateImage));
        }
    }
    {
        let op = rotate_left::RotateLeft;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rotate_left::RotateLeft));
        }
    }
    {
        let op = rotate_right::RotateRight;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rotate_right::RotateRight));
        }
    }
    {
        let op = rsa_decrypt::RSADecrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rsa_decrypt::RSADecrypt));
        }
    }
    {
        let op = rsa_encrypt::RSAEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rsa_encrypt::RSAEncrypt));
        }
    }
    {
        let op = rsa_sign::RSASign;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rsa_sign::RSASign));
        }
    }
    {
        let op = rsa_verify::RSAVerify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(rsa_verify::RSAVerify));
        }
    }
    {
        let op = salsa20::Salsa20Op;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(salsa20::Salsa20Op));
        }
    }
    {
        let op = scan_for_embedded_files::ScanForEmbeddedFiles;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(scan_for_embedded_files::ScanForEmbeddedFiles));
        }
    }
    {
        let op = scatter_chart::ScatterChart;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(scatter_chart::ScatterChart));
        }
    }
    {
        let op = scrypt::ScryptOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(scrypt::ScryptOp));
        }
    }
    {
        let op = series_chart::SeriesChart;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(series_chart::SeriesChart));
        }
    }
    {
        let op = set_difference::SetDifference;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(set_difference::SetDifference));
        }
    }
    {
        let op = set_intersection::SetIntersection;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(set_intersection::SetIntersection));
        }
    }
    {
        let op = set_union::SetUnion;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(set_union::SetUnion));
        }
    }
    {
        let op = sha0::SHA0;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sha0::SHA0));
        }
    }
    {
        let op = sha1::SHA1;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sha1::SHA1));
        }
    }
    {
        let op = sha2::SHA2;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sha2::SHA2));
        }
    }
    {
        let op = sha3::SHA3;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sha3::SHA3));
        }
    }
    {
        let op = shake::SHAKE;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(shake::SHAKE));
        }
    }
    {
        let op = sharpen_image::SharpenImage;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sharpen_image::SharpenImage));
        }
    }
    {
        let op = show_base64_offsets::ShowBase64Offsets;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(show_base64_offsets::ShowBase64Offsets));
        }
    }
    {
        let op = show_on_map::ShowOnMap;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(show_on_map::ShowOnMap));
        }
    }
    {
        let op = shuffle::Shuffle;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(shuffle::Shuffle));
        }
    }
    {
        let op = sigaba::SigabaOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sigaba::SigabaOp));
        }
    }
    {
        let op = sleep::Sleep;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sleep::Sleep));
        }
    }
    {
        let op = sm2_decrypt::Sm2Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sm2_decrypt::Sm2Decrypt));
        }
    }
    {
        let op = sm2_encrypt::Sm2Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sm2_encrypt::Sm2Encrypt));
        }
    }
    {
        let op = sm3::SM3;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sm3::SM3));
        }
    }
    {
        let op = sm4_decrypt::Sm4Decrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sm4_decrypt::Sm4Decrypt));
        }
    }
    {
        let op = sm4_encrypt::Sm4Encrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sm4_encrypt::Sm4Encrypt));
        }
    }
    {
        let op = snefru::SNEFRU;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(snefru::SNEFRU));
        }
    }
    {
        let op = sort::Sort;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sort::Sort));
        }
    }
    {
        let op = split::Split;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(split::Split));
        }
    }
    {
        let op = split_colour_channels::SplitColourChannels;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(split_colour_channels::SplitColourChannels));
        }
    }
    {
        let op = sql_beautify::SQLBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sql_beautify::SQLBeautify));
        }
    }
    {
        let op = sql_minify::SQLMinify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sql_minify::SQLMinify));
        }
    }
    {
        let op = ssdeep::SSDEEP;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(ssdeep::SSDEEP));
        }
    }
    {
        let op = standard_deviation::StandardDeviation;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(standard_deviation::StandardDeviation));
        }
    }
    {
        let op = streebog::Streebog;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(streebog::Streebog));
        }
    }
    {
        let op = strings::Strings;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strings::Strings));
        }
    }
    {
        let op = strip_html_tags::StripHTMLTags;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strip_html_tags::StripHTMLTags));
        }
    }
    {
        let op = strip_http_headers::StripHTTPHeaders;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strip_http_headers::StripHTTPHeaders));
        }
    }
    {
        let op = strip_ipv4_header::StripIPv4Header;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strip_ipv4_header::StripIPv4Header));
        }
    }
    {
        let op = strip_tcp_header::StripTCPHeader;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strip_tcp_header::StripTCPHeader));
        }
    }
    {
        let op = strip_udp_header::StripUDPHeader;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(strip_udp_header::StripUDPHeader));
        }
    }
    {
        let op = sub::SUB;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sub::SUB));
        }
    }
    {
        let op = subsection::Subsection;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(subsection::Subsection));
        }
    }
    {
        let op = substitute::Substitute;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(substitute::Substitute));
        }
    }
    {
        let op = subtract::Subtract;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(subtract::Subtract));
        }
    }
    {
        let op = sum::Sum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(sum::Sum));
        }
    }
    {
        let op = swap_case::SwapCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(swap_case::SwapCase));
        }
    }
    {
        let op = swap_endianness::SwapEndianness;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(swap_endianness::SwapEndianness));
        }
    }
    {
        let op = symmetric_difference::SymmetricDifference;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(symmetric_difference::SymmetricDifference));
        }
    }
    {
        let op = syntax_highlighter::SyntaxHighlighter;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(syntax_highlighter::SyntaxHighlighter));
        }
    }
    {
        let op = tail::Tail;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(tail::Tail));
        }
    }
    {
        let op = take_bytes::TakeBytes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(take_bytes::TakeBytes));
        }
    }
    {
        let op = take_nth_bytes::TakeNthBytes;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(take_nth_bytes::TakeNthBytes));
        }
    }
    {
        let op = tar::Tar;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(tar::Tar));
        }
    }
    {
        let op = tcpip_checksum::TCPIPChecksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(tcpip_checksum::TCPIPChecksum));
        }
    }
    {
        let op = template::Template;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(template::Template));
        }
    }
    {
        let op = text_encoding_brute_force::TextEncodingBruteForce;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(text_encoding_brute_force::TextEncodingBruteForce));
        }
    }
    {
        let op = text_integer_converter::TextIntegerConverter;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(text_integer_converter::TextIntegerConverter));
        }
    }
    {
        let op = to_base::ToBase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base::ToBase));
        }
    }
    {
        let op = to_base32::ToBase32;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base32::ToBase32));
        }
    }
    {
        let op = to_base45::ToBase45;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base45::ToBase45));
        }
    }
    {
        let op = to_base58::ToBase58;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base58::ToBase58));
        }
    }
    {
        let op = to_base62::ToBase62;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base62::ToBase62));
        }
    }
    {
        let op = to_base64::ToBase64;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base64::ToBase64));
        }
    }
    {
        let op = to_base85::ToBase85;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base85::ToBase85));
        }
    }
    {
        let op = to_base92::ToBase92;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_base92::ToBase92));
        }
    }
    {
        let op = to_bcd::ToBCD;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_bcd::ToBCD));
        }
    }
    {
        let op = to_bech32::ToBech32;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_bech32::ToBech32));
        }
    }
    {
        let op = to_binary::ToBinary;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_binary::ToBinary));
        }
    }
    {
        let op = to_braille::ToBraille;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_braille::ToBraille));
        }
    }
    {
        let op = to_camel_case::ToCamelCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_camel_case::ToCamelCase));
        }
    }
    {
        let op = to_case_insensitive_regex::ToCaseInsensitiveRegex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_case_insensitive_regex::ToCaseInsensitiveRegex));
        }
    }
    {
        let op = to_charcode::ToCharcode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_charcode::ToCharcode));
        }
    }
    {
        let op = to_decimal::ToDecimal;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_decimal::ToDecimal));
        }
    }
    {
        let op = to_float::ToFloat;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_float::ToFloat));
        }
    }
    {
        let op = to_hex::ToHex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_hex::ToHex));
        }
    }
    {
        let op = to_hex_content::ToHexContent;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_hex_content::ToHexContent));
        }
    }
    {
        let op = to_hexdump::ToHexdump;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_hexdump::ToHexdump));
        }
    }
    {
        let op = to_html_entity::ToHTMLEntity;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_html_entity::ToHTMLEntity));
        }
    }
    {
        let op = to_kebab_case::ToKebabCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_kebab_case::ToKebabCase));
        }
    }
    {
        let op = to_lower_case::ToLowerCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_lower_case::ToLowerCase));
        }
    }
    {
        let op = to_message_pack::ToMessagePack;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_message_pack::ToMessagePack));
        }
    }
    {
        let op = to_modhex::ToModhex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_modhex::ToModhex));
        }
    }
    {
        let op = to_morse_code::ToMorseCode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_morse_code::ToMorseCode));
        }
    }
    {
        let op = to_octal::ToOctal;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_octal::ToOctal));
        }
    }
    {
        let op = to_punycode::ToPunycode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_punycode::ToPunycode));
        }
    }
    {
        let op = to_quoted_printable::ToQuotedPrintable;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_quoted_printable::ToQuotedPrintable));
        }
    }
    {
        let op = to_snake_case::ToSnakeCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_snake_case::ToSnakeCase));
        }
    }
    {
        let op = to_table::ToTable;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_table::ToTable));
        }
    }
    {
        let op = to_unix_timestamp::ToUNIXTimestamp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_unix_timestamp::ToUNIXTimestamp));
        }
    }
    {
        let op = to_upper_case::ToUpperCase;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(to_upper_case::ToUpperCase));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(triple_des_decrypt::TripleDESDecrypt));
        }
    }
    {
        let op = triple_des_encrypt::TripleDESEncrypt;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(triple_des_encrypt::TripleDESEncrypt));
        }
    }
    {
        let op = typex::Typex;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(typex::Typex));
        }
    }
    {
        let op = unescape_string::UnescapeString;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(unescape_string::UnescapeString));
        }
    }
    {
    ...
    }
    {
        ...
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(unicode_text_format::UnicodeTextFormat));
        }
    }
    {
        let op = unique::Unique;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(unique::Unique));
        }
    }
    {
    ...
    }
    {
        let op = untar::Untar;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(untar::Untar));
        }
    }
    {
        let op = unzip::Unzip;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(unzip::Unzip));
        }
    }
    {
        let op = url_decode::URLDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(url_decode::URLDecode));
        }
    }
    {
        let op = url_encode::URLEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(url_encode::URLEncode));
        }
    }
    {
        let op = varint_decode::VarIntDecode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(varint_decode::VarIntDecode));
        }
    }
    {
        let op = varint_encode::VarIntEncode;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(varint_encode::VarIntEncode));
        }
    }
    {
        let op = view_bit_plane::ViewBitPlane;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(view_bit_plane::ViewBitPlane));
        }
    }
    {
        let op = vigenere_decode::VigenereDecodeOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(vigenere_decode::VigenereDecodeOp));
        }
    }
    {
        let op = vigenere_encode::VigenereEncodeOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(vigenere_encode::VigenereEncodeOp));
        }
    }
    {
        let op = whirlpool::WHIRLPOOL;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(whirlpool::WHIRLPOOL));
        }
    }
    {
    ...
    }
    {
        let op = wrap::WrapOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(wrap::WrapOp));
        }
    }
    {
        let op = x_path_expression::XPathExpression;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(x_path_expression::XPathExpression));
        }
    }
    {
        let op = x_salsa20::XSalsa20Op;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(x_salsa20::XSalsa20Op));
        }
    }
    {
        let op = xkcd_random_number::XkcdRandomNumberOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xkcd_random_number::XkcdRandomNumberOp));
        }
    }
    {
        let op = xml_beautify::XMLBeautify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xml_beautify::XMLBeautify));
        }
    }
    {
        let op = xml_minify::XMLMinify;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xml_minify::XMLMinify));
        }
    }
    {
        let op = xor::XorOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xor::XorOp));
        }
    }
    {
        let op = xor_brute_force::XORBruteForce;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xor_brute_force::XORBruteForce));
        }
    }
    {
        let op = xor_checksum::XORChecksum;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xor_checksum::XORChecksum));
        }
    }
    {
        let op = xxtea_decrypt::XxteaDecryptOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xxtea_decrypt::XxteaDecryptOp));
        }
    }
    {
        let op = xxtea_encrypt::XxteaEncryptOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(xxtea_encrypt::XxteaEncryptOp));
        }
    }
    {
        let op = yaml_to_json::YAMLToJSON;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(yaml_to_json::YAMLToJSON));
        }
    }
    {
        let op = yara_rules::YARARules;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(yara_rules::YARARules));
        }
    }
    {
        let op = zip::ZipOp;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(zip::ZipOp));
        }
    }
    {
        let op = zlib_deflate::ZlibDeflate;
        if op.name().to_lowercase() == lowered {
            return Some(Box::new(zlib_deflate::ZlibDeflate));
        }
    }
    {
