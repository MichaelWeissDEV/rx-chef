 ...
 * License:     Apache-2.0
 * Description: Implementation of the Set Difference operation.
 * -----------------------------------------------------------------------------
 */
...
/// Expand common escape sequences in a delimiter string.
