 ...
 * License:     Apache-2.0
 * Description: Implementation of the Multiply operation.
 * -----------------------------------------------------------------------------
 */
...
/// Multiply operation
///
/// Multiplies a list of numbers. If an item in the string is not a number it is
/// excluded from the list.  e.g. `0x0a 8 .5` becomes `40`
pub struct Multiply;
