...
fn test_snefru_256_vectors() {
    ...
    // These SNEFRU-256 vectors were independently verified against PHP's
    // `hash("snefru256", ...)` implementation (the provenance recorded by the
    // allthehashes upstream test suite), rather than generated by rx-chef.
